...
public class Exercises {
	...
	public String extraEnd(String str) {
		int lastTwoPlaces = str.length();
		int last = lastTwoPlaces - 2;
		String threeTimes = str.substring(last);
	...
	public String firstTwo(String str) {
		...
		String startingTwo = str;
		if (startingTwo.length() >= 2) {
			return startingTwo.substring(0, 2);
		} else if (startingTwo.length() == 1) {
			return startingTwo.substring(0) + "";
		} else {
			return "";
		}
	}
	...
	public String firstHalf(String str) {
		...
		int firstDivide = str.length() / 2;
		return str.substring(0, firstDivide);
	...
	public String withoutEnd(String str) {
		...
		int notTheLastOne = str.length() - 1;
		return str.substring(1, notTheLastOne);
	}
	...
	public String right2(String str) {
		...
		int moveToRight = str.length();
		int moveMath = str.length() - 2;

		if (moveToRight <= 2) {
			return str.substring(0);
		} else {
			return str.substring(moveMath) + str.substring(0, moveMath);
		}
	}
	...
	public String theEnd(String str, boolean front) {
		...
		int goBack = str.length();
		int endOfLine = goBack - 1;
		if (front) {
			return str.substring(0, 1);
		} else {
			return str.substring(endOfLine);
		}
	}
	...
	public String withouEnd2(String str) {
		...
		int byeFirstLast = str.length();
		int middleWins = byeFirstLast - 1;

		if (byeFirstLast <= 2) {
			return "";
		} else {
			return str.substring(1, middleWins);
		}
	}
	...
	public String middleTwo(String str) {
		...
		int wordLong = str.length();
		int midPoint = (wordLong / 2) - 1;
		int nextOver = midPoint + 2;
		return str.substring(midPoint, nextOver);
	}
	...
	public String nTwice(String str, int n) {
		...
		int lastFirst = firstLast - n;

		return str.substring(0, n) + str.substring(lastFirst);
	}
