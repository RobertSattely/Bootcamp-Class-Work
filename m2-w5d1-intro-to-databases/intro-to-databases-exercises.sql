...
SELECT name, region FROM country WHERE region <> 'Caribbean' AND continent IN ('North America','South America');
...
SELECT name, continent, gnp, lifeexpectancy FROM country WHERE lifeexpectancy > 69 AND gnp BETWEEN 1 AND 100;
...
SELECT name, 2017 - indepyear as years_since_indep FROM country WHERE indepyear IS NOT NULL;